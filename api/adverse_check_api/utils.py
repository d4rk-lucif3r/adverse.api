...
def search(pep_name):
    ...
    request_body = (
        '{ "query": { "multi_match" : { "query":    "(%s)", "fields": [ "full_name", "aliases", "first_name", "last_name", "native_name", "birth_name", "father", "mother", "siblings", "spouse", "children", "relatives" ], "operator":   "and", "fuzziness" : "AUTO" } } }'
        % pep_name
    )
