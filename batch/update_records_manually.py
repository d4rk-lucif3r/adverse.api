...
posts = collection_batches.find({'Key word Used for identify the article': {"$regex": query}})

for post in posts:
    if post["Key word Used for identify the article"] == "crime, drug":
        post["Key word Used for identify the article"] = post["Key word Used for identify the article"].split(',')
        ...
        post["Key word Used for identify the article"] = ', '.join(post["Key word Used for identify the article"])
        ...
        post["Key word Used for identify the article"] = "deleted_this" # post["Key word Used for identify the article"].split(',')
        # post["Key word Used for identify the article"] = [x.strip() for x in post["Key word Used for identify the article"]]
        # post["Key word Used for identify the article"] = [x for x in post["Key word Used for identify the article"] if x != 'drug']
        collection_batches.save(post)
