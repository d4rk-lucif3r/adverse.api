...
csv_columns = ['name', 'org', 'loc', 'keyword', 'hdfcpresent', 'date', 'sourcename', 'weblink']

news_link = ['https://www.thehindu.com/news/international/pak-court-sentences-lakhvi-to-5-years-in-terror-financing-case/article33529260.ece']
