...
for document in cursor_names:
        ...
        document['names'] = [x.strip() for x in document['names'] if x != 'Puri']
...
for document in cursor_fp_list:
        ...
        document['fp_city'] = [x.strip() for x in document['fp_city'] if x != 'Puri']
        ...
        document['fp_name'] = [x.strip() for x in document['fp_name'] if x != 'Puri']
