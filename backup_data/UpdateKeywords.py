...
for document in cursor:
    ...
    if date >= week:
            ...
            for keyword in keywords:
                ...
                if keyword.isupper():
                    ...
                    if len(keyword.split(" ")) > 1:
                        ...
                        Ktext = list(set(Ktext))
                        found = [
                            __keyword for __keyword in _keyword if __keyword in Ktext
                        ]
        ...
        if document["Key word Used for identify the article"]:
            document["Key word Used for identify the article"] = SplitStripUnique(
                document["Key word Used for identify the article"]
            )
            document["Key word Used for identify the article"] = ",".join(
                document["Key word Used for identify the article"]
            )
